...
CREATE TABLE `ORDER_LIST` (
  ...
  `ORDER_ID` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,'指向订单表外键'
  `GOODS_ID` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
...
insert  into `au_user`(`id`,`loginCode`,`password`,`password2`,`userName`,`sex`,`birthday`,`cardType`,`cardTypeName`,`idCard`,`country`,`mobile`,`email`,`userAddress`,`postCode`,`createTime`,`referId`,`referCode`,`roleId`,`roleName`,`userType`,`userTypeName`,`isStart`,`lastUpdateTime`,`lastLoginTime`,`bankAccount`,`bankName`,`accountHolder`,`idCardPicPath`,`bankPicPath`) values (2,'admin','123456','123456','系统管理员','女','2000-11-25','1','身份证','123456','中国','13522614019','123@hanlu.com','北京市成府路207号','121212','2014-03-03 00:00:00',1,'admin',1,'管理员','','',1,'2014-04-09 16:27:54','2014-04-10 16:29:08','3423423432432','中国银行','张果','/statics/uploadfiles/1396950060999_IDcard.jpg','/statics/uploadfiles/1396950267285_bank.jpg'),(73,'JBIT','123456','123456','清华','','2011-04-10','1','身份证','123456','中国','123456','','','','2014-04-10 00:00:00',2,'admin',2,'会员','1','注册会员',1,'2014-04-10 14:41:14','2014-04-10 15:15:26','123456','北京银行','北大','/statics/uploadfiles/1397098771656_IDcard.jpg','/statics/uploadfiles/1397112341821_bank.jpg');
